<template>
    <section class="page__section local__work">
        <div class="page__section__inner">
            ...
            <SiteButton :buttonLink="'/about-us'" :buttonText="'About Us'" :backgroundColor="1" :color="1"/>
        </div>
    </section>
</template>
...
<style>
    ...
    .work__text .page__section__header::after {
